...
const Desvendando = () => {
  ...
  const handleOptionClick = (optionId: string) => {
    const selectedOption = arrOption.find(option => option.id === optionId);

    if (selectedOption) {
      setTitleModal(selectedOption.title);
      setTextModal(selectedOption.text);
      setImgModal(selectedOption.src);
      setShowOption(true);
    }
  };
        ...
        >
          <div className="group-image">
            <img
              ...
              className="img-mapa"
            />
            {/* 6. Aplicação da lógica de clique nos botões do mapa */}
            <button
              className="btn-mapa btn-mapa-1 m1"
              onClick={() => handleOptionClick("m1")}
            ></button>
            <button
              className="btn-mapa btn-mapa-2 m2"
              onClick={() => handleOptionClick("m2")}
            ></button>
            <button
              className="btn-mapa btn-mapa-3 m3"
              onClick={() => handleOptionClick("m3")}
            ></button>
            <button
              className="btn-mapa btn-mapa-4 m4"
              onClick={() => handleOptionClick("m4")}
            ></button>
            <button
              className="btn-mapa btn-mapa-5 m5"
              onClick={() => handleOptionClick("m5")}
            ></button>
            <button
              className="btn-mapa btn-mapa-6 m6"
              onClick={() => handleOptionClick("m6")}
            ></button>
            <button
              className="btn-mapa btn-mapa-7 m25"
              onClick={() => handleOptionClick("m25")}
            ></button>
            <button
              className="btn-mapa btn-mapa-8 m21"
              onClick={() => handleOptionClick("m21")}
            ></button>
          </div>
